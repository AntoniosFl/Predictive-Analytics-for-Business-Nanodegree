...
### **Data** ###
  ...
  * [StoreDemographicData.csv](https://video.udacity-data.com/topher/2016/November/582bff9e_storedemographicdata/storedemographicdata.csv) - This file contains demographic data for the areas surrounding each of the existing stores and locations for new stores.
